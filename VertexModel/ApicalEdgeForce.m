function vtx = ApicalEdgeForce(edge, vtx, flag)

%% Apical extension/constriction
% find the lateral edges and affiliated vertices
els=find(edge.type==1);
vl1=edge.vtx(els,1);
vl2=edge.vtx(els,2);
...
vtx.f_apicaledge(1:vtx.numb,1) = sum(fx)';
vtx.f_apicaledge(1:vtx.numb,2) = sum(fy)';
